...
},{"./components":3,"./factories/altmetricsService":48,"./factories/apiCallInterceptor":49,"./factories/dbSearchHttpCallInterceptor":50,"./factories/feedService":51,"./factories/feedbackService":52,"./factories/filterLocationsService":53,"./factories/messageService":54,"./factories/windowEventListener":55,"./primo-explore-dom/js/primo":56,"./primo-explore-dom/js/primo/explore/helper":59,"./templates":65}],3:[function(require,module,exports){
'use strict';
...
},{"./components/general/ConfigLanguageSelection":4,"./components/general/databaseLink":5,"./components/general/deprecatedViews":6,"./components/general/disclaimer":8,"./components/general/experiment":9,"./components/general/exposeJwt":10,"./components/general/removeAlerts":11,"./components/general/removeCheckLocations":12,"./components/general/searchTip":13,"./components/general/staticFooter":14,"./components/prmAutoPromoteLogin/autoPromoteLogin":15,"./components/prmBriefResultAfter/altmetric":16,"./components/prmBriefResultAfter/briefLocationsForBibliographicView":17,"./components/prmBriefResultAfter/sourceIcon":18,"./components/prmCollectionGalleryHeaderAfter/exploreSearchCollections":19,"./components/prmFacetAfter/filterFacetValues":20,"./components/prmFacetAfter/searchAlso":21,"./components/prmFacetExactAfter/searchAlsoBody":22,"./components/prmFacetExactAfter/searchAlsoBodyBib":23,"./components/prmFacetExactAfter/searchAlsoBodyGoogle":24,"./components/prmFacetExactAfter/searchAlsoBodyWorldcat":25,"./components/prmFinesOverviewAfter/payMyFines":26,"./components/prmFullViewAfter/altmetricsBadge":27,"./components/prmFullViewAfter/locationsForBibliographicView":28,"./components/prmFullViewServiceContainerAfter/URLDecodeLinkLabel":29,"./components/prmLogoAfter/betaSwitch":30,"./components/prmLogoAfter/homeIcon":31,"./components/prmLogoAfter/languageDependentLogo":32,"./components/prmLogoAfter/newSearchButton":33,"./components/prmLogoAfter/viewLogo":34,"./components/prmMainMenuAfter/feedback":35,"./components/prmRecommendationItemAfter/recommendationItem":36,"./components/prmRequestsAfter/illRequestForm":37,"./components/prmSearchResultAvailabilityLineAfterController/browzine":38,"./components/prmSearchResultThumbnailContainerAfter/pnxXml":39,"./components/prmServiceDetailsAfter/externalLinksInDetails":40,"./components/prmServiceHeaderAfter/reportAProblem":41,"./components/prmServiceHeaderAfter/requestACopy":42,"./components/prmServiceHeaderAfter/requestACopyOfEsDoc":43,"./components/prmTopBarBefore/announcements":44,"./components/prmTopBarBefore/feedbackAnnouncement":45,"./components/prmTopBarBefore/finesMessage":47,"./utils":66}],4:[function(require,module,exports){
'use strict';
...
},{"os":1}],21:[function(require,module,exports){
'use strict';
...
},{"../prmFacetExactAfter/searchAlsoBodyBib":23}],30:[function(require,module,exports){
'use strict';
...
},{"./feedbackAnnouncementDialog":46}],46:[function(require,module,exports){
'use strict';
...
},{"../components/general/dialog":7}],53:[function(require,module,exports){
"use strict";
...
},{"./primo/explore":57,"./primo/explore/helper":59,"./primo/facets":60,"./primo/records":61,"./primo/user":62,"./primo/view":63}],57:[function(require,module,exports){
'use strict';
...
},{"./explore/components":58,"./explore/helper":59}],58:[function(require,module,exports){
'use strict';
...
},{"../../vendor/css-selector-generator.js":64,"./helper":59}],59:[function(require,module,exports){
'use strict';
  ...
  _createClass(Helper, null, [{
    ...
    value: function userDetailsHTTP() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this2.http.get(_this2.restBaseURLs.userSettingsBaseURL + '?vid=' + viewCode).then(function (userDetails) {
    ...
    value: function userFinesHTTP() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this3.http.get(_this3.restBaseURLs.myAccountBaseURL + '/fines').then(function (userFines) {
          try {
    ...
    value: function userLoansHTTP() {
      ...
      return new Promise(function (resolve, reject) {
        _this4.http.get(_this4.restBaseURLs.myAccountBaseURL + '/loans').then(function (userLoans) {
          try {
    ...
    get: function get() {
      var injector = this.injector();
      if (injector) {
        var h = injector.get('restBaseURLs');
        if (h) {
          return h;
        }
      }
...
},{"./explore/components":58,"./explore/helper":59}],61:[function(require,module,exports){
'use strict';
...
},{"./explore/components":58,"./explore/helper":59}],62:[function(require,module,exports){
'use strict';
...
},{"./explore/helper":59}],63:[function(require,module,exports){
'use strict';
...
},{"./explore/helper":59}],64:[function(require,module,exports){
'use strict';
